...
<div id="page_title">Add Stations</div>
<div class="dashboard ">
    ...
    <div class="pannel">
        ...
        <div class="pannel-body col-lg-7">
            <div class="pg_name">
                <h3 class="mb-0">Add Station</h3>
            </div>
            <form action="javascript:;" method="post">
                <div class="field mb-4">
                    <p class="field_lable">Title*:</p>
                    <input type="text" name="" placeholder="BOAT Washing Stations" class="input_field">
                </div>
                <div class="field mb-4">
                    <span class="upload_img_box">
                        <i class="fa fa-cloud-upload" aria-hidden="true"></i>
                        <input type="file" name="" class="upload_img">
                    </span>
                </div>
                <div class="field mb-4">
...
<div class="paypopup updated text-center">
    <div class="poppup_box">
        ...
        <div class="content">
            ...
            <p class="black tc my-4">Stations Added Successfully!</p>
            <ul class="btn_set">
