        ...
        <div class="pannel-body col-lg-7">
            ...
            <form action="javascript:;" method="post">
                <div class="field mb-4">
                    ...
                    <input type="text" name="" placeholder="Monthly Plan" class="input_field">
                </div>
                <div class="field mb-4">
                    <p class="field_lable">Plan Cost ($)*:</p>
                    <input type="text" name="" placeholder="$25" class="input_field">
                </div>
                <div class="field mb-4">
...
<div class="paypopup updated text-center">
    <div class="poppup_box">
        ...
        <div class="content">
            ...
            <p class="black tc my-4">Subscription Updated Successfully!</p>
            <ul class="btn_set">
