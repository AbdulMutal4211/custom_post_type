		...
		<div class="user_info">
	       <div class="clm">
	           <ul>
	               ...
	               <li><a href="announcement.php" class="active">Announcements <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
        ...
        <div id="content">
               <form method="POST" action="" enctype="multipart/form-data">
  	            ...
  	            <div class="upload-box">
                   ...
                   <!--     </label>-->
                   <!-- </div>-->
                    <div class="section_select" style="display:none;">
                        <select name="name" id="name">
                            <option value="<?php echo $_SESSION['username']; ?>">your name</option>
                        </select>
                    </div>
  	               <div>
                        <textarea id="attch_name" class="text" class="teach-text" name="anounce_txt" placeholder="Type Subject & Class Name..." required></textarea>
  	               </div>
  	               <div>
  		               <button type="submit" class="submit" name="announce">Post</button>
  	               </div>
  	            </div>
            </form>
        </div>
