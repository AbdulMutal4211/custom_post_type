...
<html>
<head>
	<title>Vication Assignments</title>
...
<div class="chat_body">
		...
		<div class="user_info">
	       <div class="clm">
	           <ul>
	               ...
	               <li><a href="assignment.php" class="active">Vication Assignments <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
	...
	<div class="chat_panel">
        <h1>Vication Assignments</h1>
        <div class="file_box_outer">
	    <div id="content">
	        <!--<ul>-->
            <?php
                // while ($row = mysqli_fetch_array($vication)){
            ...
            <!--</ul>-->
	        <ul>
	            <li><a href="ac-one.php">Class 1</a></li>
	            <li><a href="ac-two.php">Class 2</a></li>
	            <li><a href="ac-three.php">Class 3</a></li>
	            <li><a href="ac-four.php">Class 4</a></li>
	            <li><a href="ac-five.php">Class 5</a></li>
	            <li><a href="ac-six.php">Class 6</a></li>
	            <li><a href="ac-seven.php">Class 7</a></li>
	            <li><a href="ac-eight.php">Class 8</a></li>
	            <li><a href="ac-nine.php">Class 9</a></li>
	            <li><a href="ac-ten.php">Class 10</a></li>
            </ul>
