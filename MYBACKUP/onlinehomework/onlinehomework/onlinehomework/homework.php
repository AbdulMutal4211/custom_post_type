...
<div class="chat_body">
	...
	<div class="user-panel">
		...
		<div class="user_info">
	       <div class="clm">
	           <ul>
	               <li><a href="homework.php" class="active">Home Works <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
	...
	<div class="chat_panel">
	    ...
	    <div id="content">
	        <ul>
	            <li><a href="h-class-one.php">Class 1</a></li>
	            <li><a href="hc-two.php">Class 2</a></li>
	            <li><a href="hc-three.php">Class 3</a></li>
	            <li><a href="hc-four.php">Class 4</a></li>
	            <li><a href="hc-five.php">Class 5</a></li>
	            <li><a href="hc-six.php">Class 6</a></li>
	            <li><a href="hc-seven.php">Class 7</a></li>
	            <li><a href="hc-eight.php">Class 8</a></li>
	            <li><a href="hc-nine.php">Class 9</a></li>
	            <li><a href="hc-ten.php">Class 10</a></li>
            <?php
