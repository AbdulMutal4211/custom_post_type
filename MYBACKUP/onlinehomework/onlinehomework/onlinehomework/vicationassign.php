...
<div class="chat_body">
	...
	<div class="user-panel">
		...
		<div class="user_info">
	       <div class="clm">
	           <ul>
	               <li><a href="upload.php">Upload Home Work</a></li>
	               <li><a href="vicationassign.php" class="active">Upload Assignments <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
	...
	<div class="chat_panel">
	    ...
	    <div id="content">
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_One)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Two)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Three)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Five)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Six)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Seven)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Eight)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Nine)){
	        ...
	        <ul>
            <?php
                while ($row = mysqli_fetch_array($AC_Ten)){
  	            ...
  	            <div class="upload-box">
                    ...
                    <div class="section_select">
                        <select name="section" id="sections">
                            ...
                            <option value="AC_One">Class 1</option>
                            <option value="AC_Two">Class 2</option>
                            <option value="AC_Three">Class 3</option>
                            <option value="AC_Four">Class 4</option>
                            <option value="AC_Five">Class 5</option>
                            <option value="AC_Six">Class 6</option>
                            <option value="AC_Seven">Class 7</option>
                            <option value="AC_Eight">Class 8</option>
                            <option value="AC_Nine">Class 9</option>
                            <option value="AC_Ten">Class 10</option>
                        </select>
                    </div>
  	               <div>
